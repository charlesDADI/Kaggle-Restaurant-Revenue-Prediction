...
train <- read.csv("/home/charles-abner/Bureau/Docs/0.Knowledge/3.ML/TFI/data/train.csv",header=TRUE)
test <- read.csv("/home/charles-abner/Bureau/Docs/0.Knowledge/3.ML/TFI/data/test.csv",header=TRUE)
...
write.csv(submit,"/home/charles-abner/Bureau/Docs/0.Knowledge/3.ML/TFI/data/submission.csv",row.names=FALSE,quote=FALSE)
